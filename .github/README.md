...
# Yukki Music Bot <img src="https://img.shields.io/github/v/release/TeamYukki/Hams-2/YukkiMusicBo?color=black&logo=github&logoColor=black&style=social" alt="LICENSE">

[Yukki Music Bot](https://github.com/TeamYukki/Hams-2/YukkiMusicBo) is a Powerful Telegram Music+Video Bot written in Python using Pyrogram and Py-Tgcalls by which you can stream songs, video and even live streams in your group calls via various sources.
...
For more information on the technologies that power the Yukki Music Bot, check out the [Docs](https://notreallyshikhar.gitbook.io/Hams-2/YukkiMusicBo/).
...
> The official [documentation site](https://notreallyshikhar.gitbook.io/Hams-2/YukkiMusicBo/) contains a lot of information. The best place to start is from the deployment section.
...
- [Pyrogram String Session](https://notreallyshikhar.gitbook.io/Hams-2/YukkiMusicBo/deployment/string-session)
...
> Checkout [Docs](https://notreallyshikhar.gitbook.io/Hams-2/YukkiMusicBo/deployment/local-hosting-or-vps) for Detailed Explanation on VPS Deploy


```console
shikhar@MacBook~ $ git clone https://github.com/notreallyshikhar/Hams-2/YukkiMusicBo
shikhar@MacBook~ $ cd Hams-2/YukkiMusicBo
...
- [GitHub Issues](https://github.com/TeamYukki/Hams-2/YukkiMusicBo/issues/new?assignees=&labels=question&template=SUPPORT_QUESTION.md&title=support%3A+)
- Contact options listed on [this GitHub profile](https://github.com/TeamYukki)
- [Telegram Support](https://t.me/YukkiSupport)

## 🎗 Project assistance

If you want to say **thank you** or/and support active development of Hams-2/YukkiMusicBo:

- Add a [GitHub Star](https://github.com/TeamYukki/Hams-2/YukkiMusicBo) to the project.
- Fork the Repo :)
...
Together, we can make Hams-2/YukkiMusicBo **better**!
...
For a full list of all authors and contributors, see [the contributors page](https://github.com/TeamYukki/Hams-2/YukkiMusicBo/contributors).

## ⚠️ Security

Hams-2/YukkiMusicBo follows good practices of security, but 100% security cannot be assured. Hams-2/YukkiMusicBo is provided **"as is"** without any **warranty**. Use at your own risk.
